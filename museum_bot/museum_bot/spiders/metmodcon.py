...
if LastCrawl.objects.get(spider_name="metmodcon").last_crawled != today:

    class MetModConSpider(Spider):
        name = "metmodcon"
        allowed_domains = ["metmuseum.org"]
        start_urls = [
            'http://www.metmuseum.org/api/collection/collectionlisting?artist=&department=21&era=&geolocation=&material=&offset=0&pageSize=0&perPage=100&showOnly=onDisplay&sortBy=Relevance&sortOrder=asc',
            'http://www.metmuseum.org/api/collection/collectionlisting?artist=&department=21&era=&geolocation=&material=&offset=100&pageSize=0&perPage=100&showOnly=onDisplay&sortBy=Relevance&sortOrder=asc',
            'http://www.metmuseum.org/api/collection/collectionlisting?artist=&department=21&era=&geolocation=&material=&offset=200&pageSize=0&perPage=100&showOnly=onDisplay&sortBy=Relevance&sortOrder=asc',
            'http://www.metmuseum.org/api/collection/collectionlisting?artist=&department=21&era=&geolocation=&material=&offset=300&pageSize=0&perPage=100&showOnly=onDisplay&sortBy=Relevance&sortOrder=asc',
            'http://www.metmuseum.org/api/collection/collectionlisting?artist=&department=21&era=&geolocation=&material=&offset=400&pageSize=0&perPage=100&showOnly=onDisplay&sortBy=Relevance&sortOrder=asc',
            'http://www.metmuseum.org/api/collection/collectionlisting?artist=&department=21&era=&geolocation=&material=&offset=500&pageSize=0&perPage=100&showOnly=onDisplay&sortBy=Relevance&sortOrder=asc',
        ...
        def from_crawler(cls, crawler, *args, **kwargs):
            spider = super(MetModConSpider, cls).from_crawler(crawler, *args, **kwargs)
        ...
        def spider_closed(self, spider):
            LastCrawl.objects.filter(spider_name="metmodcon").update(last_crawled=today)